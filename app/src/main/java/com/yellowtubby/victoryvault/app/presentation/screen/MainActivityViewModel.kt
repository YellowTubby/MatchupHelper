...
class MainActivityViewModel : BaseViewModel<MainActivityUIState>() {
    ...
    private val getDefinedChampionsUseCase: ChampionListUseCase by KoinJavaComponent.inject(
        ChampionListUseCase::class.java,
        qualifier = named("defined")
    )
    private val getMultiSelectedMatchupsUseCase : GetMultiSelectedMatchupsUseCase by KoinJavaComponent.inject(
        GetMultiSelectedMatchupsUseCase::class.java
    )
    private val addMultiSelectedMatchupsUseCase : AddMultiSelectedMatchupsUseCase by KoinJavaComponent.inject(
        AddMultiSelectedMatchupsUseCase::class.java
    )
    private val removeMultiSelectedMatchupsUseCase : RemoveMultiSelectedMatchupsUseCase by KoinJavaComponent.inject(
